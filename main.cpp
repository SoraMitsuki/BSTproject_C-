/**
  ...
  * Date: 1/20/2017
  */
// this file is used to test the actors.txt that provided us for name seaching
// we have added the necessary lines that TODO asked
...
int main(int argc, char* argv[])
{
    ...
    if(!in.is_open()) 
    {
        ...
        while (prompt != 'n') {
            ...
            if (tree.find(name) != BSTIterator<string>(NULL)) {
